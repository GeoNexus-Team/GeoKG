...
| 口径 | 实体数 | 派生占比 | 说明 |
|------|--------|----------|------|
| ① 基础策展参考数据 | **1,709** | 0% | 人工整理的参考表（GADM 来源数据已移出） |
| ② ① + 系统性展开 | **7,590** | 0% | 加星座成员、扩展行政区、扩展词汇 |
| ③ ② + 国家级监测任务空间 | **13,999** | 45.8% | 加「国家 × 指标」 |
| ④ ③ + 次国家级监测任务空间 | **94,126** | **91.9%** | 加「一级行政区 × 指标」 |
...
**90.7% 的实体来源未核实**——详见 [`docs/provenance-audit.md`](docs/provenance-audit.md)。
