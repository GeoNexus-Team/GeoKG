...
| 口径 | 实体数 | 派生占比 | 说明 |
|------|--------|----------|------|
| ① 基础策展参考数据 | **2,103** | 0% | 人工整理的参考表 |
| ② ① + 系统性展开 | **6,216** | 0% |  GeoNames 行政区 + 扩展词汇（卫星已改由 OSCAR 提供） |
| ③ ② + 国家级监测任务空间 | **13,437** | 45.3% | 加「国家 × 指标」 |
| ④ ③ + 次国家级监测任务空间 | **125,319** | **93.2%** | 加「一级行政区 × 指标」 |
